...
from remote_terminal.beacon_encoder import BeaconGenerator, GeneratedBeacon
...
from remote_terminal.optics import BeamModel, beam_diameter_m, beam_width_rad, is_emitting
