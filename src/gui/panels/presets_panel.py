...
def _far_formation(**kw):
    """Helper: formation offset far from src.camera (bottom-right) to force raster search."""
    from src.remote_terminal.config import RemoteFormationConfig
...
def _build_bundles():
    ...
    from src.disturbance.core.config import DisturbanceConfig  # keep import for type parity
    from src.environment.config import EnvironmentConfig
