...
from src.common.protocol.beacon.navigation import NavigationState2D
from src.remote_terminal.beacon_encoder import CHIP_DURATION_S, FIRST_FRAME_STAGGER_CHIPS, BeaconGenerator
from src.remote_terminal.config import RemoteTerminalConfig
from src.remote_terminal.geometry import GeometryEngine
from src.remote_terminal.models import OpticalEmission, RemoteTerminalRuntime, Vector2
from src.remote_terminal.optics import BeamModel, beam_diameter_m, is_emitting
