...
from src.common.config_base import BaseValidatedConfig, clip_field
...
class DisturbanceConfig(BaseValidatedConfig):
    ...
    def validate(self) -> "DisturbanceConfig":
        ...
        if found_prof is None:
            # try internal map
            from src.disturbance.core.constants import PLATFORM_PROFILE_MAP as _map
    ...
    def propagation_channel_config(self):
        ...
        from src.disturbance.optical.channel import AttenuationConfig, PropagationChannel
