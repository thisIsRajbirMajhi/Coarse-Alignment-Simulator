# beacon_tracker/phases/acquired/handler.py
# Isolated ACQUIRED algorithm — probation before lock
# Moved from acquired/handler.py; imports updated to beacon_tracker paths
