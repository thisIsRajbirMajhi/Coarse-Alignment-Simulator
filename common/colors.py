...
Purpose: Single source for lock-state colors — hex and BGR — eliminates 4+ duplicates
         (tracking handlers, gui.core.renderer, overlay.constants).
Public API: LOCK_STATUS_COLORS_HEX, LOCK_STATUS_COLORS_BGR, lock_color_hex, lock_color_bgr
Notes: Searching=#64748b, Acquired=#06b6d4, Tracking/Locked=#22c55e, Lost=#ef4444, Detecting=#3b82f6 (optional).
       BGR is for cv2 (blue,green,red), HEX for Qt/CSS.
"""

from __future__ import annotations

# ============================================================
# SECTION: Canonical lock colors — single source
# ============================================================
