...
class CameraPanel(BaseConfigPanel):
    ...
    def _build_ui(self) -> None:
        ...
        self.god_w_spin = QSpinBox(); lo,hi = DISPLAY_LIMITS["god_width"]; self.god_w_spin.setRange(lo, hi); self.god_w_spin.setSuffix(" px"); self.god_w_spin.setToolTip("God View fixed 5000x5000 — not configurable."); self.god_w_spin.setEnabled(False); self.god_w_spin.setMinimumHeight(26)
        disp_grid.addWidget(self.god_w_spin, 1, 1)
        disp_grid.addWidget(self._label("H"), 1, 2)
        self.god_h_spin = QSpinBox(); lo,hi = DISPLAY_LIMITS["god_height"]; self.god_h_spin.setRange(lo, hi); self.god_h_spin.setSuffix(" px"); self.god_h_spin.setToolTip("God View fixed 5000x5000."); self.god_h_spin.setEnabled(False); self.god_h_spin.setMinimumHeight(26)
        disp_grid.addWidget(self.god_h_spin, 1, 3)
        disp_hint = QLabel("God View fixed 5000x5000, Camera Screen 2000-5000 configurable")
